...
from app.models import interview as interview_model  # ensure model is imported
from app.models import interview_credit as interview_credit_model  # ensure model is imported
